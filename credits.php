...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
  ...
  $date = $_POST["date1"];
  $time = $_POST["time1"];
$sql = "INSERT INTO `credits`(`userid`, `description`, `credit_amount`, `date`, `time`) VALUES ('$username','$description','$amount','$date','$time')";
...
<body style="background-color: black;">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
          ...
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
              ...
              <a href="/PFMS/allcredits.php"><button class="btn btn-outline-success">All-Credits</button></a>
      ...
      ";}
      ?>
    <form action="/PFMS/credits.php" method="post">
        <div class="col-md-10">
